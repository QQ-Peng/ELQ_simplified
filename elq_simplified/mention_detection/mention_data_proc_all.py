...
class ReadTrainDectMent(Dataset):
    def __init__(self,file_path,destroy_raw_data=True):
        ...
        self.QuesToken_ids, self.GoldMentSpan_idx,self.MentToEntID=self.get_ques_GoldMentSpan()
    ...
    def get_ques_GoldMentSpan(self):
        ...
        return QuesToken_ids, GoldMentionSpan_idx,MentToEntID
    ...
    def padding(self):
        ...
        for i in range(self.data_size):
            ...
            #padding MentToEntID
            self.MentToEntID[i]+=[-1]*(self.max_num_gold_mention-num_gold_cur)
        ...
        if not self.shuffle:
            while self.cur_pos<self.data_size:
                ...
                one_batch=(self.data.QuesToken_ids[self.cur_pos:self.cur_pos+self.batch_size],
                           ...
                           self.data.MentToEntID[self.cur_pos:self.cur_pos+self.batch_size]
                           )
            ...
            while self.cur_pos<self.data_size:
                ...
                for i in range(self.batch_size):
                    ...
                    ment_to_entity.append(self.data.MentToEntID[rand_idx[self.cur_pos+i]])
                self.cur_pos+=self.batch_size
